...
public class RuokakomeroApplication {
	...
	@Bean
	public CommandLineRunner demo(RuokaRepository repository) {
		
		return (args) -> {
			
			repository.save(new Ruoka("Olut", "23 tlk", "Karhu, 0,33"));
			repository.save(new Ruoka("Kahvi", "2 pkt", "Juhla Mokka, 500g"));
			repository.save(new Ruoka("Sokeri", "1 pkt", "Valkoinen taloussokeri"));
			/*
